...
public class ConsoleTheme implements Theme {
    ...
    public static final CustomRegistry<ConsoleTheme> CONSOLE_THEMES_REGISTRY = CustomRegistry.create(ConsoleTheme.class, new ResourceLocation(TardisRefined.MODID, "console_theme"));
    /** Global instance of the Console Theme custom registry created by Tardis Refined*/
    public static final DeferredRegistry<ConsoleTheme> CONSOLE_THEMES = DeferredRegistry.create(TardisRefined.MODID, CONSOLE_THEMES_REGISTRY);

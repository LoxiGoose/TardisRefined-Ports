...
public class ConsolePatterns{
    ...
    public static Map<ResourceLocation, List<ConsolePattern>> registerDefaultPatterns() {
        ...
        for (RegistrySupplier<ConsoleTheme> currentConsoleTheme : ConsoleTheme.CONSOLE_THEMES.getEntries()) {
            ResourceLocation consoleTheme = ConsoleTheme.CONSOLE_THEMES_REGISTRY.getKey(currentConsoleTheme.get());
